    ...
    <div class="row inputs-marg">
        <div class="col-lg-4 pb-5">
            ...
            <div class="wizard">
                ...
                <a class="list-group-item active " href="Gestionuser.php"><i class="fe-icon-user text-muted"></i>Information génerale</a>
                    <a class="list-group-item " href="Gestionuser2.php"><i class="fe-icon-map-pin text-muted"></i>Sécurité</a>
                </nav>
            </div>
        </div>
        <!-- Profile Settings-->
