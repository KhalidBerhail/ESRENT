      ...
      if($newpass==$confnewpass)
        {
          ...
          $statement->execute();
          header("Location: Gestionuser2.php");
        }else
        ...
        <div class="col-lg-4 pb-5">
            ...
            <div class="wizard">
                <nav class="list-group list-group-flush">
                    ...
                    <a class="list-group-item " href="Gestionuser.php"><i class="fe-icon-user text-muted"></i>Information génerale</a>
                    <a class="list-group-item active" href="Gestionuser2.php"><i class="fe-icon-map-pin text-muted"></i>Sécurité</a>
